...
"""
dNG.pas.data.upnp.resources.VideoMpegStream
"""
"""n// NOTE
----------------------------------------------------------------------------
...
class VideoMpegStream(AbstractStream):
#
	"""
...
:since:  v0.1.00
		...
		#if (_return): self.didl_res_protocol = "http-get:*:video/mpeg:DLNA.ORG_PN=MP3;DLNA.ORG_OP=01;DLNA.ORG_FLAGS={0:0>8x}000000000000000000000000".format(VideoMpegStream.DLNA_STREAM | VideoMpegStream.DLNA_0150)
		return _return
	#
#

...
"""
dNG.pas.data.upnp.resources.ImageJpegThumbnail
"""
"""n// NOTE
----------------------------------------------------------------------------
...
class ImageJpegThumbnail(AbstractStream):
#
	"""
...
:since:  v0.1.00
		...
		if (_return): self.didl_res_protocol = "http-get:*:image/jpeg:DLNA.ORG_PN=JPEG_TN;DLNA.ORG_OP={0:0>2x};DLNA.ORG_FLAGS={1:0>8x}000000000000000000000000".format(ImageJpegThumbnail.DLNA_SEEK_BYTES, ImageJpegThumbnail.DLNA_STREAM | ImageJpegThumbnail.DLNA_0150)
		return _return
	#
#

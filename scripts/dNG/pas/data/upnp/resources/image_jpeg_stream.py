...
"""
dNG.pas.data.upnp.resources.ImageJpegStream
"""
"""n// NOTE
----------------------------------------------------------------------------
...
class ImageJpegStream(AbstractStream):
#
	"""
...
:since:  v0.1.00
		...
		if (_return): self.didl_res_protocol = "http-get:*:image/jpeg:DLNA.ORG_PN=JPEG_LRG;DLNA.ORG_OP={0:0>2x};DLNA.ORG_FLAGS={1:0>8x}000000000000000000000000".format(ImageJpegStream.DLNA_SEEK_BYTES, ImageJpegStream.DLNA_STREAM | ImageJpegStream.DLNA_0150)
		return _return
	#
#
